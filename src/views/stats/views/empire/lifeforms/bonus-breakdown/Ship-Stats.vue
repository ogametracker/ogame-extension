...
<script lang="ts">
    ...
    import { ShipStatsBonusLifeformTechnologies } from '@/shared/models/ogame/lifeforms/technologies/LifeformTechnologies';
    ...
    export default class ShipStats extends Vue {
        ...
        private readonly LifeformTechnologies = ShipStatsBonusLifeformTechnologies.map(x => x.type).sort((a, b) => a - b);
        ...
        private get items(): BonusOverviewItem[] {
            return this.planets.map<BonusOverviewItem>(planet => {
                ...
                ShipStatsBonusLifeformTechnologies.forEach(technology => {
                    ...
                    bonuses[technology.type] = createRecord<ShipType, ShipStatsBonusBreakdown<TechnologyBonusBreakdown>>(ShipTypes, ship => {
                        const base = technology.getShipStatsBonus(ship, level);
