            ...
            if(SettingsDataModule.settings.showMsuCells) {
                result.push({
                    ...
                    getValue: reports => reports.reduce(
                        (acc, report) => acc
                            + report.lostShips.onExpeditions.resourceUnits.metal * factors.metal
                            + report.lostShips.onExpeditions.resourceUnits.crystal * factors.crystal * this.msuConversionRates.crystal
                            + report.lostShips.onExpeditions.resourceUnits.deuterium * factors.deuterium * this.msuConversionRates.deuterium,
                        0
                    ),
                });
            }
