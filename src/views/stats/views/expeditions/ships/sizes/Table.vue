<template>
    ...
    >
        <template #cell-label="{ value }">
            ...
            <span v-if="value == ExpeditionEventSize.small" class="mdi mdi-hexagon-slice-1" />
            <span v-else-if="value == ExpeditionEventSize.medium" class="mdi mdi-hexagon-slice-3" />
            <span v-else-if="value == ExpeditionEventSize.large" class="mdi mdi-hexagon-slice-5" />
        </template>
    </ranged-stats-table>
</template>
