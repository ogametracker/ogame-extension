...
class DestroyerMkIIClass extends LifeformTechnology implements ShipStatsBonusLifeformTechnology {
    public constructor() {
        super({
            metal: {
                baseCost: 160_000,
    ...
    public get type(): LifeformTechnologyType {
        return LifeformTechnologyType.destroyerMkII;
    }
}

export const DestroyerMkII = new DestroyerMkIIClass();
