...
class GeneralOverhaul_CruiserClass extends LifeformTechnology implements StatsBonusLifeformTechnology {
    public constructor() {
        super({
            metal: {
                baseCost: 160_000,
    ...
    public get type(): LifeformTechnologyType {
        return LifeformTechnologyType.generalOverhaul_cruiser;
    }
}

export const GeneralOverhaul_Cruiser = new GeneralOverhaul_CruiserClass();
