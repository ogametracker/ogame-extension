...
import { CivilShipType, MilitaryShipType, MoonShipType, NonStationaryShipType, PlanetShipType, ShipType, StationaryShipType } from "./ShipType";
...
export const MilitaryShipTypes: MilitaryShipType[] = [
    ShipType.lightFighter,
    ShipType.heavyFighter,
    ShipType.cruiser,
    ShipType.battleship,
...
export const CivilShipTypes: CivilShipType[] = [
    ShipType.smallCargo,
    ShipType.largeCargo,
    ShipType.colonyShip,
    ShipType.recycler,
