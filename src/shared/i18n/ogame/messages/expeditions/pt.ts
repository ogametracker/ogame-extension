...
export const pt: ExpeditionMessages = {
    [ExpeditionEventType.darkMatter]: {
        [ExpeditionEventSize.small]: [
            ...
            /*'Encontrámos um */'estranho alienígena numa pequena nave que nos deu um pequeno contentor'/* com Matéria Negra em troca de uns simples cálculos matemáticos.'*/,
        ...
        [ExpeditionEventSize.medium]: [
            /*'A nossa missão de */'exploração conseguiu completar um dos seus propósitos'/* ! Esta conseguiu retirar Matéria Negra duma estrela a extinguir-se.'*/,
            /*'A nossa */'missão localiza uma antiga estação espacial que'/* , ao que parece, está a flutuar sem rumo no espaço sideral. A estação em si não é recuperável mas foi descoberta alguma Matéria Negra armazenada nos seus reactores. Os nossos técnicos tentaram recuperar tanta Matéria Negra quanta puderam.'*/,
        ...
        [ExpeditionEventSize.large]: [
            /*'Uma */'deformação espontânea no hiperespaço permite'/* à tua frota recolher uma grande quantidade de Matéria Negra!'*/,
            /*'A nossa frota em exploração contactou pela primeira vez com uma raça especial. Parece que é uma criatura feita de energia pura, */'que se auto-intitula Legoriana'/* . Esta flutua por entre as naves da expedição e decide ajudar a nossa espécie subdesenvolvida - uma caixa contendo Matéria Negra foi materializada no convés da nave!'*/,
        ],
    ...
    [ExpeditionEventType.resources]: {
        ...
        [ExpeditionEventSize.large]: [
            /*'Encontrámos uma */'cinta de minerais à volta de um planeta'/* desconhecido. As naves da expedição já estão a voltar completamente cheias!'*/,
    ...
    [ExpeditionEventType.fleet]: {
        [ExpeditionEventSize.small]: [
            ...
            /*'A tua expedição */'encontrou uma fortaleza de uma antiga celebridade'/* que foi abandonada. No hangar da fortaleza encontrámos algumas naves. Os técnicos estão a tentar ver se algumas ainda estão operacionais.'*/,
            /*'A nossa expedição encontrou um */'planeta que quase foi totalmente destruído durante uma guerra'/* . Conseguimos encontrar várias naves a orbitar o planeta. Os técnicos estão a tentar reparar algumas delas, talvez também poderemos reunir algumas informações do que se passou por ali.'*/,
        ...
        [ExpeditionEventSize.medium]: [
            ...
            /*'Encontrámos */'o resto de uma armada'/* ! Os técnicos voaram para as naves que estavam mais intactas e tentaram metê-las a funcionar!'*/,
        ],
        [ExpeditionEventSize.large]: [
            /*'Encontrámos */'um enorme cemitério de naves'/* ! Os Engenheiros de Máquinas conseguiram meter algumas a funcionar e estas estão a voltar connosco!'*/,
    ...
    [ExpeditionEventType.early]: [
        /*'Um problema inesperado no */'campo energético dos motores fez com que a expedição'/* voltasse mais rapidamente para casa. Os relatórios primários não revelam qualquer descoberta.'*/,
