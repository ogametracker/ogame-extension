...
export const es: ExpeditionMessages = {
    ...
    [ExpeditionEventType.pirates]: {
        ...
        'fled-death-star': [
            /*LOCA: es 'Your expedition stumbled across some pirates, but overwhelmed by the magnitude of your Deathstar, they fled.' */
        ],
    },
    ...
    depletionMessages: {
        ...
        [ExpeditionDepletionLevel.medium]: [
            ...
            /*'encontramos */'indicios sobre la presencia de otras flotas'/* de expedición'*/,
