...
export const hr: ExpeditionMessages = {
    [ExpeditionEventType.darkMatter]: {
        ...
        regex: /*TODO: hr */(darkMatter: string) => new RegExp(`Es wurde (?<name>${darkMatter}) (?<amount>[^\\s]+) erbeutet`, 'i'),
    },
    ...
    [ExpeditionEventType.resources]: {
        ...
        [ExpeditionEventSize.medium]: [
            ...
            /*TODO: hr 'Auf einem kleinen Mond mit eigener Atmosphäre fand deine Expedition */'große Rohstoffvorkommen'/*. Die Bodencrews sind dabei, diese natürlichen Schätze zu heben.'*/,
        ],
        [ExpeditionEventSize.large]: [
    ...
    [ExpeditionEventType.item]: {
        regex: /*TODO: hr */ /Ein (?<name>.+) wurde dem Inventar hinzugefügt/i,
    },
