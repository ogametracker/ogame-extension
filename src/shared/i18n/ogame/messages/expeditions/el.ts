...
export const el: ExpeditionMessages = {
    ...
    [ExpeditionEventType.fleet]: {
        ...
        [ExpeditionEventSize.large]: [
            ...
            /*'Εντοπίσαμε σε */'ένα πλανήτη απομεινάρια πολιτισμού'/* . Εντοπίσαμε ένα τεράστιο διαστημικό σταθμο σε τροχιά. Οι τεχνικοί και μερικοί πιλότοι πήγαν εκεί αναζητώντας σκάφη που θα μπορούσαμε να χρησιμοποιήσουμε.'*/,
        ],
    ...
    [ExpeditionEventType.lostFleet]: [
        /*'Η τελευταία εικόνα που λήφθηκε από το στόλο εξερεύνησης, */'είναι η είσοδος μιας μαύρης τρύπας',
    ...
    [ExpeditionEventType.pirates]: {
        ...
        [ExpeditionEventSize.medium]: [
            ...
            /*'Πέσαμε σε */'ενέδρα που είχε στηθεί από τους αστροπειρατές'/* . Η μάχη ήταν αναπόφευκτη.'*/,
