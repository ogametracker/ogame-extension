...
const Items = {
    ...
    "56c258e7c1f12a37773d9c95ad2e98dc3076aca6": {
        hash: "56c258e7c1f12a37773d9c95ad2e98dc3076aca6",
    ...
    "309bc42ce9e5d4587c0061ef425e9940dce9f713": {
        hash: "309bc42ce9e5d4587c0061ef425e9940dce9f713",
    ...
    "3b470998cf557da90f473c00c0f1a06c641079e4": {
        hash: "3b470998cf557da90f473c00c0f1a06c641079e4",
    ...
    "8223a42e752958f15d6392630d776af061c53e1f": {
        hash: "8223a42e752958f15d6392630d776af061c53e1f",
    ...
    "dfb5ffa09e06d48304d46aaff8686dd1beec1d24": {
        hash: "dfb5ffa09e06d48304d46aaff8686dd1beec1d24",
    ...
    "ff3e56f3f0c386c1698c56d912e47ab18b80bfa8": {
        hash: "ff3e56f3f0c386c1698c56d912e47ab18b80bfa8",
    ...
    "2a0d57915e6904a910012362abe8b1ca315a24b9": {
        hash: "2a0d57915e6904a910012362abe8b1ca315a24b9",
    ...
    "f1545f4fc66dafbc04ad02cafc87cfb5f34706fa": {
        hash: "f1545f4fc66dafbc04ad02cafc87cfb5f34706fa",
...
const mapExpo = (server, expo) => [
    ...
    expo.resources?.metal ?? 0,
    expo.resources?.crystal ?? 0,
    expo.resources?.deuterium ?? 0,
    ...Object.keys(ships).sort((a, b) => parseInt(a) - parseInt(b)).map(id => expo.fleet?.[id] ?? ''),
    expo.darkMatter ?? '',
    Items[expo.itemHash]?.name ?? '',
].join(';');
...
const headers = [
    ...
    'crystal',
    'deuterium',
    ...Object.keys(ships).sort((a, b) => parseInt(a) - parseInt(b)).map(id => ships[id]),
    'dark matter',
    'item',
].join(';');
const lines = Object.entries(data).flatMap(entry => {
    const [server, expos] = entry;

    return Object.values(expos).map(expo => mapExpo(server, expo));
});


fs.writeFileSync(`${__dirname}/data.csv`, [headers, ...lines].join('\n'));